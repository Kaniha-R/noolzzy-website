...
const products = [
  ...
  { name: "Golden Wings Cuff", category: "bracelets", price: "₹399", tag: "New", desc: "A handcrafted antique gold cuff bracelet with a graceful wing-inspired design, perfect for parties, festive occasions, and statement styling.", img: "assets/products/product4.jpg" },
  { name: "Floral Whisper Hair Set", category: "hair", price: "₹299", desc: "A coordinated floral hair accessory set featuring a scrunchie, scarf scrunchie, and bow clip. Soft, lightweight, and perfect for adding a graceful touch to everyday outfits.", img: "assets/products/product5.jpg" },
